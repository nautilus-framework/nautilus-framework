...
public class Messages {
	...
	public static String LOGIN_ERROR = "msg.login-error";
	...
	public static String FILE_UPLOADED_SUCCESS = "msg.file-uploaded-success";
	
	public static String FILE_DELETED_SUCCESS = "msg.file-deleted-success";
